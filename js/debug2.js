...
/* globals exec, log, csInterface, path, fs */

var launchDebug, selectDebugFile, addDropdownOption, loadMenuFromFile, updateVersions;
var cstkFolder, defaultChromePath, cookieFile, debugAppFile, appSelection;
...
displayExtensions = function(extensions) {
    ...
    var extension, l, n, extensionSort;
    ...
    for (n = 0; n < l; n++) {
        ...
        if (oldApp !== extension.appCode + extension.appVersion) {
            ...
            html.push(
                ...
                (oldApp === appId + appVersion ? ' (Current App)' : '') +
                '</b>'
            );
        }
        html.push(
            ...
            '<span class="csButton blueButton" id="OpenFolder_' + n + '"> Open Folder</span>' +
            ...
            (extension.debugPort ? '<span class="csButton greyButton"  id="OpenDebug_' + n + '">Debug</span>' : '') +
            '</div>'
        );
    }
    // var debugHTML = [];
